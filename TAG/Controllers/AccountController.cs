...
namespace TAG.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            var user = await UserManager.FindByNameAsync(model.EmailAddress1);
            if (user != null)
            {
            ...
            //string surname = HttpContext.GetOwinContext().GetUserManager<ApplicationUserManager>().FindById(User.Identity.GetUserId()).UserProfileCompleted;
            if (user != null && !user.UserProfileCompleted)
            {
                returnUrl = "/Home/ContactInfo";
            }
            switch (result)
            {
        ...
        public async Task<ActionResult> ConfirmEmail(string userId, string code)
        {
            ...
            //Create a new ContactInfo row in dbo.Contact for this new contact
        ...
        public async Task<ActionResult> ExternalLoginCallback(string returnUrl)
        {
            ...
            switch (result)
            {
                ...
                default:
                    ...
                    return View("ExternalLoginConfirmation", new ExternalLoginConfirmationViewModel { EmailAddress1 = loginInfo.Email });
            }
        }
        ...
        public async Task<ActionResult> ExternalLoginConfirmation(ExternalLoginConfirmationViewModel model, string returnUrl)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var user = new ApplicationUser { UserName = model.EmailAddress1, Email = model.EmailAddress1 };
